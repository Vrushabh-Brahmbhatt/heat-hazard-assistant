// src/components/HomePage.jsx - Updated with translations
    ...
    <div className="min-h-screen bg-amber-50">
            ...
            <div className="flex ml-4 flex-col sm:flex-row gap-4">
              ...
              {!user ? (
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  >
                    {logoutLoading ? t('auth.signIn.signingIn') : t('home.hero.signOut')}
                  </button>
                </div>
              )}
            </div>
      ...
      <div className="bg-white py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-navy-900 mb-10">{t('home.features.title')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="bg-amber-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold text-navy-900 mb-2">{t('home.features.realTimeAlerts.title')}</h3>
              <p className="text-gray-700">
                {t('home.features.realTimeAlerts.description')}
              </p>
            </div>
            ...
            <div className="bg-amber-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold text-navy-900 mb-2">{t('home.features.safeRoutes.title')}</h3>
              <p className="text-gray-700">
                {t('home.features.safeRoutes.description')}
              </p>
              <Link 
                to="/safe-route"
                className="inline-block mt-3 text-amber-600 hover:text-amber-700 font-medium"
              >
                {t('home.features.safeRoutes.cta')}
              </Link>
            </div>
            ...
            <div className="bg-amber-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold text-navy-900 mb-2">{t('home.features.communityReporting.title')}</h3>
              <p className="text-gray-700">
                {t('home.features.communityReporting.description')}
              </p>
            </div>
            ...
            <div className="bg-amber-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold text-navy-900 mb-2">{t('home.features.aiTips.title')}</h3>
              <p className="text-gray-700">
                {t('home.features.aiTips.description')}
              </p>
            </div>
          </div>
        </div>
